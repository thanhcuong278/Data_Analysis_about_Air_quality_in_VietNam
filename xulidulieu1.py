...
csv_path = "C:/Users/Duy Khanh/OneDrive/Desktop/train_pyhton/historical_air_quality_2021_vi.csv"  # Đường dẫn đến tệp CSV
...
# Chuyển đổi cột thời gian với định dạng hỗn hợp
...
hue_df.to_csv("C:/Users/Duy Khanh/OneDrive/Desktop/train_pyhton/hue_data.csv", index=False)  # Dữ liệu trạm tại Huế
hcm_df.to_csv("C:/Users/Duy Khanh/OneDrive/Desktop/train_pyhton/hcm_data.csv", index=False)  # Dữ liệu trạm tại Hồ Chí Minh
hanoi_df.to_csv("C:/Users/Duy Khanh/OneDrive/Desktop/train_pyhton/hanoi_data.csv", index=False)  # Dữ liệu trạm tại Hà Nội
